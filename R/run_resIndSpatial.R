...
# This code is based on the resIndSpatial function from the resInd package:https://github.com/jennifervk/resInd

# Most packages are already pre-installed on Lisa (HPC facility)
