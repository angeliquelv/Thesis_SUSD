...
resIndSpatial <- function(x, dates, type='irregular', sc=1, order=3,
  ...
  fun <- function(x){
    ...
    #Save all indicators::
    resind <- cbind(bpnumb, MIni, MEnd, as.numeric(Int), DBP,
                    DBP_bpt, as.numeric(DBP_trendrecov), as.numeric(DBP_pretrend), DBP_preNDVI, DBP_MagA,
                    DBP_MagR, DBP_AmpDiff, DBP_Type, FBP, FBP_bpt,
                    as.numeric(FBP_trendrecov), as.numeric(FBP_pretrend), FBP_preNDVI, FBP_MagA, FBP_MagR,
                    FBP_AmpDiff, FBP_Type)

    colnames(resind) <- c('BPNumb', 'Initial NDVI', 'End NDVI', 'Intercept', 'DBP',
                          'DBPTime','RecTrendDBP', 'PreTrendDBP', 'DBPPreNDVI', 'DBPMagObsA',
                          'DBPMagObsR', 'DBPAmpDiffR','DBPType', 'FBP','FBPTime',
                          'RecTrendFBP', 'PreTrendFBP', 'FBPPreNDVI', 'FBPMagObsA', 'FBPMagObsR',
                          'FBPAmpDiffR','FBPType')
  ...
  names(out) <- c('BPNumb', 'Initial NDVI', 'End NDVI', 'Intercept', 'DBP',
                  'DBPTime','RecTrendDBP', 'PreTrendDBP', 'DBPPreNDVI', 'DBPMagObsA',
                  'DBPMagObsR', 'DBPAmpDiffR','DBPType', 'FBP','FBPTime',
                  'RecTrendFBP', 'PreTrendFBP', 'FBPPreNDVI', 'FBPMagObsA', 'FBPMagObsR',
                  'FBPAmpDiffR','FBPType')
